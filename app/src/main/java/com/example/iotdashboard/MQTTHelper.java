...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"tamquattnb123/feeds/yolo-temp"};

    final String clientId = "12345678";

    final String password = "aio_Xwbr87eswMKk9gE533Gm0GZTWZxn";

    final String serverUri = "tcp://io.adafruit.com:1883";

    final String username = "tamquattnb123";
